...
import com.ziyin.rabbitmq.spring.entity.Order;
import com.ziyin.rabbitmq.spring.entity.Packaged;
...
public class RabbitmqSpringApplicationTests {
	...
	public void contextLoads() {
		...
		rabbitAdmin.declareBinding(BindingBuilder.bind(new Queue("test.topic.queue", false))
				.to(new TopicExchange("test.topic", false, false)).with("topic.#"));


		/**
		 * fanoutexchange 不走路由键
		 */
	...
	public void testMessage() throws Exception {
		...
		Message message = new Message(StrUtil.bytes("hello rabbit", CharsetUtil.UTF_8),messageProperties);
	...
	public void testMessage2() throws Exception {
		...
		rabbitTemplate.convertAndSend("topic001", "spring.amqp", "msg send..");
		rabbitTemplate.convertAndSend("topic002", "rabbit.amqp", "msg send..");
	...
	public void testSendJavaMessage() throws Exception {
		...
		//这里注意一定要修改contentType为 application/json
		messageProperties.setContentType("application/json");
		messageProperties.getHeaders().put("__TypeId__", "com.ziyin.rabbitmq.spring.entity.Order");
		Message message = new Message(json.getBytes(), messageProperties);
